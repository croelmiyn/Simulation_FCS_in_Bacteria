...
public class Simu_FCS_Brownian  implements PlugIn {
    ...
    private void simulate(){
        ...
        for(int t=0; t<nFrames; t++){
            ...
            for(int k=0;k<nObjects;k++){
                ...
                pos[k][0]+=Dr*rd.nextGaussian();
                pos[k][1]+=Dr*rd.nextGaussian();
                pos[k][2]+=Dr*rd.nextGaussian();
